...
export const flexVariants: Record<FlexVariants, string> = styleVariants({
  ...
  responsive: {
    flexDirection: 'column',
    '@media': { [media.small]: { flexDirection: 'row' } },
  },
});
...
export const padding = styleVariants(theme.space, (paddingVar) => ({ padding: paddingVar }));
export const paddingY = styleVariants(theme.space, (paddingVar) => ({
...
export const order = styleVariants({ 0: 0, 1: 1, 2: 2, 3: 3 }, (orderVar) => ({ '@media': { [media.small]: { order: orderVar } } }));
...
export const marginLeft = styleVariants(
  ...
  (marginLeftVar) => ({ marginLeft: marginLeftVar }),
);
...
export const marginRight = styleVariants(
  ...
  (marginRightVar) => ({ marginRight: marginRightVar }),
);
...
export const marginTop = styleVariants(
  ...
  (marginTopVar) => ({ marginTop: marginTopVar }),
);
...
export const marginBottom = styleVariants(
  ...
  (marginBottomVar) => ({ marginBottom: marginBottomVar }),
);
...
export const text: Record<TextVariants, string> = styleVariants({
  ...
  superHeading: [
    margin0,
    {
      ...
      '@media': { [media.small]: { fontSize: theme.fontSizes[7] } },
    },
  ],
  heading: [
    margin0,
    {
      ...
      letterSpacing: theme.letterSpacings.tight,
      '@media': { [media.medium]: { fontSize: theme.fontSizes[6] } },
    },
  ],
  subhead: [
    margin0,
  ...
  mega: [
    margin0,
    {
      ...
      letterSpacing: theme.letterSpacings.tight,
      '@media': { [media.medium]: { fontSize: '360px' } },
    },
  ],
...
export const buttons: Record<ButtonVariants, string> = styleVariants({
  primary: [
    button,
    {
      ...
      ':hover': { background: theme.colors.active },
      ':focus': { background: theme.colors.active },
    },
  ],
  reversed: [
    button,
    {
      color: theme.colors.buttonReversedTextColor,
      background: theme.colors.buttonReversedBackground,
      ':hover': {
        color: theme.colors.buttonReversedActiveTextColor,
        background: theme.colors.buttonReversedActiveBackground,
      },
      ':focus': {
        color: theme.colors.buttonReversedActiveTextColor,
        background: theme.colors.buttonReversedActiveBackground,
...
export type Backgrounds = 'primary' | 'muted' | 'block';
...
export const backgrounds: Record<Backgrounds, string> = styleVariants({
  ...
  block: {
    color: theme.colors.blockTextColor,
...
export const iconLink = style({
  ...
  ':hover': { color: theme.colors.active },
  ':focus': { color: theme.colors.active },
});
...
// for debugging only
export const debug = style({ outline: '1px solid tomato' });
